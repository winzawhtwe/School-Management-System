...
if (isset($_POST['grade_code'])    &&
    ...
    if (empty($grade_code)) {
        ...
        header("Location: ../admin/grade-add.php?error=$em&$data");
        exit;
    }else if (empty($grade)) {
        ...
        $sm = "New grade added successfully!";
        header("Location: ../admin/grade-add.php?success=$sm");
        exit;
    }

    }else {
        $em = "Error occured";
        header("Location: ../admin/grade-add.php?error=$em");
        exit;
    } 
    }else {
