...
if (isset($_POST['fname'])    &&
    ...
    $data = 'uname='.$uname.'&fname='.$fname.'&lname='.$lname.'&address='.$address.
            'gender='.$gender.'&email='.$email_address.'&date_of_birth='.$date_of_birth.
            '&pf='.$parent_fname.'&pl='.$parent_lname.'&pn='.$parent_phone_number;

    if (empty($fname)) {
        $em = "First name is required";
        header("Location: ../admin/student-add.php?error=$em&$data");
        exit;
    }else if (empty($lname)) {
        ...
        $sql = "INSERT INTO
                student(username, password, fname, lname, grade, section, address, gender, email_address,
        ...
        header("Location: ../admin/student-add.php?success=$sm");
        exit;
    }

    }else {
        $em = "Error occured";
        header("Location: ../admin/student-add.php?error=$em");
        exit;
    } 
    }else {
