...
if (isset($_SESSION['r_user_id']) && 
    ...
    if ($_SESSION['role'] == 'Registrar_Office') {
        ...
        if (isset($_GET['pf'])) $parent_fname = $_GET['pf'];
        if (isset($_GET['pl'])) $parent_lname = $_GET['pl'];
        if (isset($_GET['pn'])) $parent_phone_number = $_GET['pn'];
?>
<!DOCTYPE html>
<html lang = "en">
    <head>
        ...
        <div class="container mt-5">
            <a href="index.php"
                ...
                <form method="post"
                      ...
                      action="../registrar_office/req/student-add.php">
