...
if (isset($_SESSION['teacher_id']) && 
    ...
    if ($_SESSION['role'] == 'Teacher') {
        ...
        $subject = getSubjectByGrade($student['grade'], $conn);
...
<html lang = "en">
    ...
    <body>
        <?php
            ...
            if ($student != 0 && $setting !=0 && $subject !=0 && $teacher_subjects != 0) { 
        ?>
        <div class=" d-flex justify-content-center align-items-center flex-column">
        <div   class="login shadow mt-5 p-3">  
        <form method="post"
              action="">
                <div class="mb-3">
                <ul class="list-group">
            ...
            ?>
                ...
                <input type="" name="student_id" value="<?=$student_id?>" hidden>
                <input type="" name="subject_id" value="<?=$ssubject_id?>" hidden>
                <input type="" name="current_semester" value="<?=$setting['current_semester']?>" hidden>
                <input type="" name="current_year" value="<?=$setting['current_year']?>" hidden><br />
