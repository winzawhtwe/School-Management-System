...
if (isset($_SESSION['admin_id']) && 
    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        if (isset($_GET['en'])) $employee_number = $_GET['en'];
        if (isset($_GET['pn'])) $phone_number = $_GET['pn'];
        if (isset($_GET['qf'])) $qualification = $_GET['qf'];
...
<html lang = "en">
    <head>
        ...
        initial-scale=1.0">
        <title>Admin - Add New Registrar Office User</title>
