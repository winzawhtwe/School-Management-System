    ...
    <body>
        ...
        <div class="container mt-5">
            <a href="registrar-office.php"
                ...
                <h3>Edit Registrar Office</h3><hr>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                            class="form-control"
                            value="<?=$registrar_office['username']?>"
                            name="Username">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" 
                            class="form-control"
                            value="<?=$registrar_office['address']?>"
                            name="address">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" 
                            class="form-control"
                            value="<?=$registrar_office['employee_number']?>"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" 
                            class="form-control"
                            value="<?=$registrar_office['date_of_birth']?>"
                            name="date_of_birth">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" 
                            class="form-control"
                            value="<?=$registrar_office['phone_number']?>"
                            name="phone_number">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" 
                            class="form-control"
                            value="<?=$registrar_office['qualification']?>"
                            name="qualification">
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" 
                            class="form-control"
                            value="<?=$registrar_office['email_address']?>"
                            name="email_address">
                </div>
                <div class="mb-3">
                    ...
                    <input type="radio"
                            value="Male"
                            <?php if($registrar_office['gender'] == 'Male') echo 'checked'; ?>
                            name="gender"> Male
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio"
                            value="Female"
                            <?php if($registrar_office['gender'] == 'Female') echo 'checked'; ?>
                            name="gender"> Female
                </div>
                <input type="text"
                       value="<?=$registrar_office['r_user_id']?>"
                       name="r_user_id"
                       hidden>
